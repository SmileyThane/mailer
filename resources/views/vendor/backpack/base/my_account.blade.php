                ...
                <div class="card padding-10">
                    ...
                    <div class="card-body backpack-profile-form bold-labels">
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                @php
                                    $label = 'Last name';//trans('backpack::base.name');
                                    $field = 'lastname';
                                @endphp
                                <label >{{ $label }}</label>
                            ...
                            <div class="col-md-6 form-group">
                                @php
                                    $label = 'Sender name';//trans('backpack::base.name');
                                    $field = 'sender_name';
                                @endphp
                                <label >{{ $label }}</label>
                                <input class="form-control" type="text" name="{{ $field }}" value="{{ old($field) ? old($field) : $user->$field }}">
                            ...
                            <div class="col-md-6 form-group">
                                @php
                                    $label = 'Sender email';//trans('backpack::base.name');
                                    $field = 'sender_email';
                                @endphp
                                <label >{{ $label }}</label>
                                <input class="form-control" type="email" name="{{ $field }}" value="{{ old($field) ? old($field) : $user->$field }}">
                            </div>
